        ...
        <div class="add">
            <form class="layui-form" action="">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="price_list_name" value="{{$data['price_list_name']}}" required  lay-verify="required" placeholder="商品名称" autocomplete="off" class="layui-input">
                    </div>
                </div>
                <div class="layui-form-item">
                    <label class="layui-form-label">商品价格：</label>
                    <div class="layui-input-block">
                        <input type="text" name="price" value="{{$data['price']}}" required  lay-verify="required|number" placeholder="商品价格" autocomplete="off" class="layui-input">
                    </div>
                </div>
                <div class="layui-form-item">
                    <label class="layui-form-label">销售提成：</label>
                    <div class="layui-input-block">
                        <input type="text" name="sell_money" value="{{$data['sell_money']}}" required  lay-verify="required|number" placeholder="销售提成" autocomplete="off" class="layui-input">
                    </div>
                </div>
                <div class="layui-form-item">
                    <label class="layui-form-label">施工提成：</label>
                    <div class="layui-input-block">
                        <input type="text" name="job_money" value="{{$data['job_money']}}" required  lay-verify="required|number" placeholder="施工提成" autocomplete="off" class="layui-input">
                    </div>
                </div>
                <div class="layui-form-item">
                    <div class="layui-input-block">
    ...
    <script>
        ...
        layui.use('form', function(){
            ...
            form.on('submit(formDemo)', function(data){
                ...
                $.ajax({
                    type: 'put',
                    url: '/shop_car_goods/'+data.field.id,
