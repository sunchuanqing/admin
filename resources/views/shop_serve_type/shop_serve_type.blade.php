    ...
    <div class="admin-overall">
        ...
        <div class="admin-table">
            <div class="admin-search">
                <a href="/shop_serve_type/create?shop_id={{$shop_id}}" class="layui-btn add">
                    ...
                    <div class="layui-form-item">
                        <div class="layui-inline">
                            <div class="layui-input-inline" style="width: 200px;">
                                <input type="text" name="serve_type_name" placeholder="项目类别名称" autocomplete="off" class="layui-input">
                            </div>
                        </div>
    ...
    <script>
        layui.use('table', function(){
            ...
            var tableIns = table.render({
                elem: '#list'
                ,url: '/shop_serve_type/'+$("#shop_id").val()
                ,height: 'full-270'
                ,page: {
                ...
                ,cols: [[
                    ...
                    ,{field: 'serve_type_name', title: '类别名称', width:800}
            ...
            $("#screen").click(function(){
                tableIns.reload({
                    where: {
                        serve_type_name: $("input[name='serve_type_name']").val()
                    }
                    ,page: {
                        curr: 1
                    }
            ...
            table.on('tool(list)', function(obj){
                ...
                if(layEvent === 'del'){
                    ...
                    window.location.href = "/shop_serve_type/"+data.id+'/edit';
                }
            });
        });
    </script>
