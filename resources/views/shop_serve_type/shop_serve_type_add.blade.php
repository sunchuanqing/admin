    ...
    <div class="admin-overall">
        <div class="admin-nav">
            <span class="layui-breadcrumb">
                <a href="/">主页</a>
                <a href="/shop">门店列表</a>
                <a href="/shop_serve_type/{{$shop_id}}">项目类别列表</a>
            ...
            <form class="layui-form" action="">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="serve_type_name" required  lay-verify="required" placeholder="类别名称" autocomplete="off" class="layui-input">
                    </div>
                </div>
                <div class="layui-form-item">
                    <div class="layui-input-block">
        ...
        layui.use('form', function(){
            ...
            form.on('submit(formDemo)', function(data){
                ...
                $.ajax({
                    type: 'post',
                    url: '/shop_serve_type',
                    data: {'_token': '{{csrf_token()}}', 'serve_type_name': data.field.serve_type_name, 'shop_id': data.field.shop_id},
                    dataType: 'json',
