...
@section('content')
    ...
    <input type="hidden" name="shop_serve_id" value="{{$shop_serve_id}}">
    <div class="admin-overall">
        ...
        <div class="admin-table">
            <div class="admin-search">
                <a href="/shop_serve_photo/create?id={{$shop_serve_id}}" class="layui-btn add">
    ...
    <script>
        layui.use('table', function(){
            ...
            var tableIns = table.render({
                elem: '#list'
                ,url: '/shop_serve_photo/'+$("input[name='shop_serve_id']").val()
                ,height: 'full-270'
                ,page: {
                ...
                ,cols: [[
                    ...
                    ,{field: 'serve_thumb', title: '轮播图片', width:500, style:'cursor: pointer;', templet: function(d){return '<div class="layer-photos-demo"><img layer-pid="'+d.id+'" layer-src="'+d.original_img+'" src="'+d.serve_thumb+'"></div>';}}
            ...
            table.on('tool(list)', function(obj){
                ...
                if(layEvent === 'del'){
                    ...
                    window.location.href = "/shop_serve_photo/"+data.id+'/edit';
                }
            });
        });
    </script>
