    ...
    <div class="admin-overall">
        <div class="admin-nav">
            <span class="layui-breadcrumb">
                ...
                <a href="/shop_serve_photo/{{$shop_serve_id}}">项目相册</a>
                <a><cite>添加照片</cite></a>
            </span>
        </div>
        <div class="add">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        ...
                        <div class="layui-upload-list">
                            ...
                            <input type="hidden" name="shop_serve_photo" lay-verify="required" value="" id="shop_serve_photo">
                        </div>
                    </div>
                </div>
                <div class="layui-form-item">
    ...
    <script>
        ...
        layui.use('form', function(){
            ...
            form.on('submit(formDemo)', function(data){
                ...
                $.ajax({
                    type: 'post',
                    url: '/shop_serve_photo',
                    data: {'_token': '{{csrf_token()}}', 'shop_serve_id': $("input[name='shop_serve_id']").val(), 'shop_serve_photo': data.field.shop_serve_photo, 'sort': data.field.sort},
                    dataType: 'json',
