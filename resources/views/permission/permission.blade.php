...
@section('content')
    ...
    <div class="admin-overall">
        ...
        <div class="admin-table">
            <div class="admin-search">
                <a href="/permission/create" class="layui-btn add">
    ...
    <script type="text/html" id="barDemo">
        ...
        <a class="layui-btn layui-btn-normal layui-btn-xs" lay-event="permission">分配权限</a>
        ...
        layui.use('table', function(){
            ...
            var tableIns = table.render({
                ...
                ,cols: [[
                    ...
                    ,{field: 'name', title: '角色名称', width:500}
                    ,{field: 'created_at', title: '添加时间', width:500}
            ...
            table.on('tool(list)', function(obj){
                ...
                if(layEvent === 'del'){
                    ...
                    window.location.href = "/permission/"+data.id+'/edit';
                } else if(layEvent === 'permission'){
                    window.location.href = "/permission_role/"+data.id;
                }
            });
        });
    </script>
