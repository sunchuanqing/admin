...
@section('content')
    ...
    <div class="admin-overall">
        ...
        <div class="admin-table">
            <div class="admin-search">
                <a href="/topic/create" class="layui-btn add">
                    ...
                    <div class="layui-form-item">
                        <div class="layui-inline">
                            <div class="layui-input-inline" style="width: 200px;">
                                <input type="text" name="topic_name" placeholder="活动名称" autocomplete="off" class="layui-input">
                            </div>
                        </div>
    ...
    <script type="text/html" id="barDemo">
        ...
        <a class="layui-btn layui-btn-xs layui-btn-normal" lay-event="photo">详情图</a>
        ...
        layui.use('table', function(){
            ...
            var tableIns = table.render({
                ...
                ,cols: [[
                    ...
                    ,{field: 'topic_name', title: '专题名称', width:200}
                    ,{field: 'sort', title: '排序（大号在前）', width:200}
                    ,{field: 'status', title: '状态', width:150, templet: function(d){if(d.status === 1){return '展示';}else{return '隐藏';}}}
                    ,{field: 'is_top', title: '是否置顶', width: 150, templet: function(d){if(d.is_top === 1){return '不置顶';}else{return '置顶';}}}
            ...
            table.on('tool(list)', function(obj){
                ...
                if(layEvent === 'del'){
                    ...
                    window.location.href = "/topic/"+data.id+'/edit';
                } else if (layEvent === 'photo'){
                    window.location.href = "/topic_photo/"+data.id+'/edit';
                }
            });
        });
    </script>
