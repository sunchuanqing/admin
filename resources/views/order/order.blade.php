                        ...
                        <div class="layui-inline">
                            <div class="layui-input-inline" style="width: 200px;">
                                <select name="order_type" lay-verify="required">
                                    ...
                                    <option value="1">奢饰品护理</option>
                                    <option value="2">名车护理</option>
                                    <option value="3">花艺</option>
                                    <option value="4">优惠券</option>
                                    <option value="5">优惠服务</option>
                                    <option value="6">好货</option>
                                    <option value="7">车护年卡</option>
                                    <option value="8">礼品卡</option>
                                </select>
                            </div>
                        </div>
                        <div class="layui-inline">
                            <div class="layui-input-inline" style="width: 200px;">
                                <select name="pay_status" lay-verify="required">
        ...
        layui.use('table', function(){
            ...
            var tableIns = table.render({
                ...
                ,cols: [[
                    ...
                    ,{field: 'order_type', title: '订单类别', width:100, templet: function(d){if(d.order_type === 1){return '奢饰品护理';}else if(d.order_type === 2){return '名车护理';}else if(d.order_type === 3){return '花艺';}else if(d.order_type === 4){return '优惠券';}else if(d.order_type === 5){return '优惠服务';}else if(d.order_type === 6){return '好货';}else if(d.order_type === 7){return '年卡';}else if(d.order_type === 8){return '礼品卡';}else if(d.order_type === 9){return '积分兑换';}}}
                    ...
                    ,{field: 'pay_status', title: '支付状态', width: 90, templet: function(d){if(d.pay_status === 1){return '未付款';}else if(d.pay_status === 2){return '付款中';}else if(d.pay_status === 3){return '已付款';}else if(d.pay_status === 4){return '已退款';}}}
