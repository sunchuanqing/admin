                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        ...
                        <div class="layui-upload-list">
                            <img id="photo_img" style="height: 150px;" src="{{asset('http://img.jiaranjituan.cn/photo.png')}}" alt="">
        ...
        layui.use(['form', 'laydate'], function(){
            ...
            form.on('submit(formDemo)', function(data){
                ...
                $.ajax({
                    type: 'post',
                    url: '/user',
                    data: {'_token': '{{csrf_token()}}', 'user_name': data.field.user_name, 'photo': data.field.photo, 'phone': data.field.phone, 'sex': data.field.sex, 'flag': data.field.flag, 'birthday': data.field.birthday},
                    dataType: 'json',
