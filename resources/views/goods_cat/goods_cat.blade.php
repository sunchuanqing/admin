    ...
    <div class="admin-overall">
        ...
        <div class="admin-table">
            <div class="admin-search">
                <a href="/goods_cat/create" class="layui-btn add">
        ...
        layui.use('table', function(){
            ...
            var tableIns = table.render({
                ...
                ,cols: [[
                    ...
                    ,{field: 'names', title: '分类名称', width:500, templet: function(d){return d.names+d.name;}}
                    ,{field: 'number', title: '商品数量', width:200}
                    ,{field: 'created_at', title: '添加时间', width: 400}
