            ...
            <form class="layui-form" action="">
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="name" required  lay-verify="required" placeholder="类别名称" autocomplete="off" class="layui-input">
                    </div>
                </div>
                <div class="layui-form-item">
                    <label class="layui-form-label">图片宽度：</label>
                    <div class="layui-input-block">
                        <input type="text" name="banner_width" required  lay-verify="required" placeholder="图片推荐宽度" autocomplete="off" class="layui-input">
                    </div>
                </div>
                <div class="layui-form-item">
                    <label class="layui-form-label">图片高度：</label>
                    <div class="layui-input-block">
                        <input type="text" name="banner_height" required  lay-verify="required" placeholder="图片推荐高度" autocomplete="off" class="layui-input">
                    </div>
                </div>
                <div class="layui-form-item layui-form-text">
                    <label class="layui-form-label">类别备注：</label>
                    <div class="layui-input-block">
                        <textarea name="banner_desc" placeholder="例如在哪展示、推荐色调等等" class="layui-textarea"></textarea>
                    </div>
                </div>
                <div class="layui-form-item">
                    <div class="layui-input-block">
