    ...
    <div class="admin-overall">
        <div class="admin-nav">
            <span class="layui-breadcrumb">
                <a href="/">主页</a>
                <a><cite>轮播类型列表</cite></a>
            </span>
        </div>
        <div class="admin-table">
            <div class="admin-search">
                <a href="/banner_type/create" class="layui-btn add">
                    <i class="layui-icon">&#xe608;</i> 添加轮播类型
                </a>
                <form class="layui-form" action="">
                    <div class="layui-form-item">
                        <div class="layui-inline">
                            <div class="layui-input-inline" style="width: 200px;">
                                <input type="text" name="name" placeholder="类别名称" autocomplete="off" class="layui-input">
                            </div>
                        </div>
        ...
        layui.use('table', function(){
            ...
            var tableIns = table.render({
                ...
                ,cols: [[
                    ...
                    ,{field: 'name', title: '类别名称', width:300}
                    ,{field: 'banner_width', title: '宽度', width:150}
                    ,{field: 'banner_height', title: '高度', width: 150}
                    ,{field: 'banner_desc', title: '描述', width: 400}
            ...
            table.on('tool(list)', function(obj){
                ...
                if(layEvent === 'del'){
                    ...
                    window.location.href = "/banner_type/"+data.id+'/edit';
                }
            });
        });
    </script>
