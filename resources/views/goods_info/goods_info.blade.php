        ...
        layui.use('table', function(){
            ...
            var tableIns = table.render({
                ...
                ,cols: [[
                    ...
                    ,{field: 'goods_thumb', title: '商品图片', width:500, style:'cursor: pointer;', templet: function(d){return '<div class="layer-photos-demo"><img layer-pid="'+d.id+'" layer-src="'+d.img+'" src="'+d.img+'"></div>';}}
                    ,{field: 'sort', title: '排序（小号在前）', width: 300}
