        ...
        <div class="add">
            <form class="layui-form" action="">
                    ...
                    <div class="layui-input-block">
                        <select name="shop_type_id" lay-verify="required">
                            ...
                            @foreach($shop_type as $k => $v)
                                <option value="{{$v->id}}" {{$data['shop_type_id'] == $v->id ? 'selected' : ''}}>{{$v->type_name}}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="shop_name" value="{{$data['shop_name']}}" required  lay-verify="required" placeholder="门店名称" autocomplete="off" class="layui-input">
                    </div>
                </div>
                <div class="layui-form-item">
                    <div class="layui-inline">
                        ...
                        <div class="layui-input-block">
                            ...
                            <div class="layui-upload-list">
                                <img id="shoplogos" style="width: 110px; height: 110px;" src="{{$data['shop_logo']}}" alt="">
                                <input type="hidden" name="shop_logo" lay-verify="required" value="{{$data['shop_logo']}}" id="shop_logo">
                            </div>
                        </div>
                    </div>
                    <div class="layui-inline">
                        ...
                        <div class="layui-input-block">
                            ...
                            <div class="layui-upload-list">
                                <video id="shopvideos" style="width: 200px; height: 110px;" src="{{$data['shop_video']}}" controls="controls"></video>
                                <input type="hidden" name="shop_video" value="{{$data['shop_video']}}" id="shop_video">
                            </div>
                        </div>
                    </div>
                    <div class="layui-inline">
                        ...
                        <div class="layui-input-block">
                            ...
                            <div class="layui-upload-list">
                                <img id="shopvideoimgs" style="width: 200px; height: 110px;" src="{{$data['shop_video_img']}}" alt="">
                                <input type="hidden" name="shop_video_img" lay-verify="required" value="{{$data['shop_video_img']}}" id="shop_video_img">
                            </div>
                        </div>
                    </div>
                    <div class="layui-inline">
                        ...
                        <div class="layui-input-block">
                            ...
                            <div class="layui-upload-list">
                                <img id="shopimgs" style="width: 200px; height: 110px;" src="{{$data['shop_img']}}" alt="">
                                <input type="hidden" name="shop_img" lay-verify="required" value="{{$data['original_img']}}" id="shop_img">
                            </div>
                        </div>
                    </div>
                </div>
                <div class="layui-form-item">
                    <div class="layui-inline">
                        ...
                        <div class="layui-input-inline" style="width: 274px;">
                            <input type="text" name="start_time" value="{{$data['start_time']}}" id="start_time" placeholder="开始时间" autocomplete="off" class="layui-input">
                        </div>
                        <div class="layui-form-mid">-</div>
                        <div class="layui-input-inline" style="width: 274px;">
                            <input type="text" name="end_time" value="{{$data['end_time']}}" id="end_time" placeholder="结束时间" autocomplete="off" class="layui-input">
                        </div>
                    </div>
                </div>
                <div class="layui-form-item">
                    <div class="layui-inline">
                        ...
                        <div class="layui-input-inline" style="width: 274px;">
                            <input type="text" name="shop_admin" value="{{$data['shop_admin']}}" required  lay-verify="required" placeholder="负责人姓名" autocomplete="off" class="layui-input">
                        </div>
                        <div class="layui-form-mid">-</div>
                        <div class="layui-input-inline" style="width: 274px;">
                            <input type="text" name="shop_phone" value="{{$data['shop_phone']}}" required  lay-verify="required" placeholder="门店电话" autocomplete="off" class="layui-input">
                        </div>
                    </div>
                </div>
                <div class="layui-form-item">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="radio" name="shop_status" value="1" title="营业中" {{$data['shop_status'] == 1 ? 'checked' : ''}}>
                        <input type="radio" name="shop_status" value="2" title="休息中" {{$data['shop_status'] == 2 ? 'checked' : ''}}>
                    </div>
                </div>
                <div class="layui-form-item">
                    <label class="layui-form-label">排列顺序：</label>
                    <div class="layui-input-block">
                        <input type="text" name="sort" value="{{$data['sort']}}" required  lay-verify="required" placeholder="排列顺序（1-999大号在前）" autocomplete="off" class="layui-input">
                    </div>
                </div>
                <div class="layui-form-item">
                    <label class="layui-form-label">门店简介：</label>
                    <div class="layui-input-block">
                        <textarea name="shop_brief" placeholder="请输入内容" class="layui-textarea">{{$data['shop_brief']}}</textarea>
                    </div>
                </div>
                <div class="layui-form-item">
                    <div class="layui-input-block">
