            ...
            <form class="layui-form" action="">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="user_name" value="{{$data['user_name']}}" required  lay-verify="required|username" placeholder="用户名（不能是纯数字）" autocomplete="off" class="layui-input">
                    </div>
                </div>
                <div class="layui-form-item">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="radio" name="sex" value="2" title="保密" {{$data['sex'] == 2 ? 'checked' : ''}}>
                        <input type="radio" name="sex" value="1" title="男" {{$data['sex'] == 1 ? 'checked' : ''}}>
                        <input type="radio" name="sex" value="0" title="女" {{$data['sex'] == 0 ? 'checked' : ''}}>
                    </div>
                </div>
                <div class="layui-form-item">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="birthday" value="{{$data['birthday']}}" required id="birthday" lay-verify="required|date" placeholder="年-月-日" autocomplete="off" class="layui-input">
                    </div>
                </div>
                <div class="layui-form-item">
                    <div class="layui-input-block">
