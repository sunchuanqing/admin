    ...
    <div class="admin-overall">
        <div class="admin-nav">
            <span class="layui-breadcrumb">
                <a href="/">主页</a>
                <a href="/flower">商品列表</a>
                <a href="/flower_photo/{{$data['flower_id']}}">花束相册</a>
                <a><cite>修改相册</cite></a>
            </span>
        </div>
        <div class="add">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        ...
                        <div class="layui-upload-list">
                            <img id="flowerphotos" style="width: 300px; height: 160px;" src="{{$data['img']}}" alt="">
                            <input type="hidden" name="flower_photo" lay-verify="required" value="{{$data['img']}}" id="flower_photo">
                        </div>
                    </div>
                </div>
                <div class="layui-form-item">
    ...
    <script>
        ...
        layui.use('form', function(){
            ...
            form.on('submit(formDemo)', function(data){
                ...
                $.ajax({
                    type: 'put',
                    url: '/flower_photo/'+data.field.id,
                    data: {'_token': '{{csrf_token()}}', 'flower_photo': data.field.flower_photo, 'sort': data.field.sort},
                    dataType: 'json',
