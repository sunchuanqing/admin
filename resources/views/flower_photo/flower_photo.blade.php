    ...
    <div class="admin-overall">
        ...
        <div class="admin-table">
            <div class="admin-search">
                <a href="/flower_photo/create?flower_id={{$flower_id}}" class="layui-btn add">
    ...
    <script>
        layui.use('table', function(){
            ...
            var tableIns = table.render({
                elem: '#list'
                ,url: '/flower_photo/'+$("input[name='flower_id']").val()
                ,height: 'full-270'
                ,page: {
                ...
                ,cols: [[
                    ...
                    ,{field: 'img', title: '花束图片', width:500, style:'cursor: pointer;', templet: function(d){return '<div class="layer-photos-demo"><img layer-pid="'+d.id+'" layer-src="'+d.img+'" src="'+d.img+'"></div>';}}
            ...
            table.on('tool(list)', function(obj){
                ...
                if(layEvent === 'del'){
                    ...
                    window.location.href = "/flower_photo/"+data.id+'/edit';
                }
            });
        });
    </script>
