            ...
            <form class="layui-form" action="">
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="radio" name="gift_card_type" value="1" title="电子卡" checked>
                        <input type="radio" name="gift_card_type" value="2" title="实体卡">
                    </div>
                </div>
                <div class="layui-form-item">
                    <label class="layui-form-label">卡片名称：</label>
                    <div class="layui-input-block">
                        <input type="text" name="gift_card_name" required  lay-verify="required" placeholder="卡片名称" autocomplete="off" class="layui-input">
                    </div>
                </div>
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        ...
                        <div class="layui-upload-list">
                            <img id="giftcardfrontimgs" style="width: 200px; height: 110px;" src="/image/bj.png" alt="">
                            <input type="hidden" name="gift_card_front_img" lay-verify="required" value="" id="gift_card_front_img">
                        </div>
                    </div>
                </div>
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        ...
                        <div class="layui-upload-list">
                            <img id="giftcardreverseimgs" style="width: 200px; height: 110px;" src="/image/bj.png" alt="">
                            <input type="hidden" name="gift_card_reverse_img" lay-verify="required" value="" id="gift_card_reverse_img">
                        </div>
                    </div>
                </div>
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        ...
                        <div class="layui-upload-list">
                            <img id="giftcardinfoimgs" style="width: 200px; height: 110px;" src="/image/bj.png" alt="">
                            <input type="hidden" name="gift_card_info_img" lay-verify="required" value="" id="gift_card_info_img">
                        </div>
                    </div>
                </div>
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="gift_card_money" required  lay-verify="required" placeholder="库存" autocomplete="off" class="layui-input">
                    </div>
                </div>
                <div class="layui-form-item">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="gift_card_number" required  lay-verify="required" placeholder="库存" autocomplete="off" class="layui-input">
                    </div>
                </div>
                <div class="layui-form-item">
                    <label class="layui-form-label">简介：</label>
                    <div class="layui-input-block">
                        <input type="text" name="gift_card_brief" required  lay-verify="required" placeholder="简介" autocomplete="off" class="layui-input">
                    </div>
                </div>
                <div class="layui-form-item">
                    <label class="layui-form-label">有效天数：</label>
                    <div class="layui-input-block">
                        <input type="text" name="gift_card_period" required  lay-verify="required" placeholder="有效天数" autocomplete="off" class="layui-input">
                    </div>
                </div>
                <div class="layui-form-item">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <textarea name="gift_card_notice" placeholder="使用须知" class="layui-textarea"></textarea>
                    </div>
                </div>
                <div class="layui-form-item">
                    <div class="layui-input-block">
