    ...
    <div class="admin-overall">
        ...
        <div class="admin-table">
            <div class="admin-search">
                <a href="/version/create" class="layui-btn add">
                    ...
                    <div class="layui-form-item">
                        <div class="layui-inline">
                            <div class="layui-input-inline" style="width: 200px;">
                                <input type="text" name="version_number" placeholder="版本号" autocomplete="off" class="layui-input">
                            </div>
                        </div>
        ...
        layui.use('table', function(){
            ...
            var tableIns = table.render({
                ...
                ,cols: [[
                    ...
                    ,{field: 'version_number', title: '版本号', width:300}
                    ,{field: 'version_info', title: '版本信息', width:300}
                    ,{field: 'version_url', title: '版本地址', width: 400}
