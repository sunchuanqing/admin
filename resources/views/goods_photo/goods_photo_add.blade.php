    ...
    <div class="admin-overall">
        <div class="admin-nav">
            <span class="layui-breadcrumb">
                <a href="/">主页</a>
                <a href="/goods">门店列表</a>
                <a href="/goods_photo/{{$goods_id}}">门店相册列表</a>
                <a><cite>添加相册</cite></a>
            </span>
        </div>
        <div class="add">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        ...
                        <div class="layui-upload-list">
                            <img id="goodsphotos" style="width: 300px; height: 160px;" src="/image/bj.png" alt="">
                            <input type="hidden" name="goods_photo" lay-verify="required" value="" id="goods_photo">
                        </div>
                    </div>
                </div>
                <div class="layui-form-item">
        ...
        layui.use('form', function(){
            ...
            form.on('submit(formDemo)', function(data){
                ...
                $.ajax({
                    type: 'post',
                    url: '/goods_photo',
                    data: {'_token': '{{csrf_token()}}', 'goods_id': data.field.goods_id, 'goods_photo': data.field.goods_photo, 'sort': data.field.sort},
                    dataType: 'json',
