    ...
    <div class="admin-overall">
        <div class="admin-nav">
            <span class="layui-breadcrumb">
                <a href="/">主页</a>
                <a href="/goods">商品列表</a>
                <a href="/goods_photo/{{$data['goods_id']}}">商品相册列表</a>
                <a><cite>修改相册</cite></a>
            </span>
        </div>
        <div class="add">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        ...
                        <div class="layui-upload-list">
                            <img id="goodsphotos" style="width: 300px; height: 160px;" src="{{$data['goods_thumb']}}" alt="">
                            <input type="hidden" name="goods_photo" lay-verify="required" value="{{$data['original_img']}}" id="goods_photo">
                        </div>
                    </div>
                </div>
                <div class="layui-form-item">
    ...
    <script>
        ...
        layui.use('form', function(){
            ...
            form.on('submit(formDemo)', function(data){
                ...
                $.ajax({
                    type: 'put',
                    url: '/goods_photo/'+data.field.id,
                    data: {'_token': '{{csrf_token()}}', 'goods_photo': data.field.goods_photo, 'sort': data.field.sort},
                    dataType: 'json',
