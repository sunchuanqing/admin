            ...
            <form class="layui-form" action="">
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="name" required  lay-verify="required" placeholder="优惠券名称" autocomplete="off" class="layui-input">
                    </div>
                </div>
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        ...
                        <div class="layui-upload-list">
                            <img id="imgurls" style="width: 150px; height: 60px;" src="/image/bj.png" alt="">
                            <input type="hidden" name="img" lay-verify="required" value="" id="img">
                        </div>
                    </div>
                </div>
                <div class="layui-form-item">
                    <div class="layui-inline">
                        ...
                        <div class="layui-input-inline" style="width: 274px;">
                            <input type="text" name="start_time" id="start_time" placeholder="开始时间" lay-verify="required" autocomplete="off" class="layui-input">
                        </div>
                        <div class="layui-form-mid">-</div>
                        <div class="layui-input-inline" style="width: 274px;">
                            <input type="text" name="end_time" id="end_time" placeholder="结束时间" lay-verify="required" autocomplete="off" class="layui-input">
                        </div>
                    </div>
                </div>
                <div class="layui-form-item">
                    <div class="layui-inline">
                        ...
                        <div class="layui-input-inline" style="width: 274px;">
                            <input type="text" name="number" lay-verify="required|number" placeholder="优惠券发放数量" autocomplete="off" class="layui-input">
                        </div>
                        <div class="layui-form-label">领取数量：</div>
                        <div class="layui-input-inline" style="width: 274px;">
                            <input type="text" name="user_number" lay-verify="required|number" placeholder="每位用户可领取最大的数量" autocomplete="off" class="layui-input">
                        </div>
                    </div>
                </div>
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="pay_money" required  lay-verify="required|number" placeholder="0为免费类型 大于0为付费金额" autocomplete="off" class="layui-input">
                    </div>
                </div>
                <div class="layui-form-item">
                    <label class="layui-form-label">券类别：</label>
                    <div class="layui-input-block">
                        <input type="radio" name="coupon_type" lay-filter="coupon_type" value="1" title="现金券" checked>
                        <input type="radio" name="coupon_type" lay-filter="coupon_type" value="2" title="满减券">
                        <input type="radio" name="coupon_type" lay-filter="coupon_type" value="3" title="新人券">
                        <input type="radio" name="coupon_type" lay-filter="coupon_type" value="4" title="积分兑换券">
                    </div>
                </div>
                <div class="layui-form-item">
                    <div class="layui-inline">
                        ...
                        <div class="layui-input-inline" style="width: 274px;">
                            <input type="text" name="money" lay-verify="required|number" placeholder="优惠金额" autocomplete="off" class="layui-input">
                        </div>
                        <div class="layui-form-label">最小金额：</div>
                        <div class="layui-input-inline" style="width: 274px;">
                            <input type="text" name="full_money" lay-verify="required|number" placeholder="使用优惠券的最低金额（0代表不限额）" autocomplete="off" class="layui-input">
                        </div>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="radio" name="subject_type" value="1" title="通用" checked>
                        <input type="radio" name="subject_type" value="2" title="门店">
                        <input type="radio" name="subject_type" value="3" title="好货">
                        <input type="radio" name="subject_type" value="4" title="指定商品">
                    </div>
                </div>
                <div class="layui-form-item">
                    <label class="layui-form-label">发放类型：</label>
                    <div class="layui-input-block">
                        <input type="radio" name="grant_type" value="1" title="后台发放" checked>
                        <input type="radio" name="grant_type" value="2" title="用户领取">
                        <input type="radio" name="grant_type" value="3" title="系统发放">
                    </div>
                </div>
                <div class="layui-form-item">
