    ...
    <div class="admin-overall">
        <div class="admin-nav">
            <span class="layui-breadcrumb">
                ...
                <a href="/coupon_subject/{{$id}}">绑定商品列表</a>
                <a><cite>绑定商品</cite></a>
            </span>
        </div>
        <div class="add">
            <form class="layui-form" action="">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="goods_sn" lay-verify="required|number" placeholder="商品的20位编号" autocomplete="off" class="layui-input">
                    </div>
                </div>
                <div class="layui-form-item">
                    <div class="layui-input-block">
    ...
    <script>
        ...
        layui.use('form', function(){
            ...
            form.on('submit(formDemo)', function(data){
                ...
                $.ajax({
                    type: 'post',
                    url: '/coupon_goods/'+data.field.id,
                    data: {'_token': '{{csrf_token()}}', 'goods_sn': data.field.goods_sn},
                    dataType: 'json',
