            ...
            <form class="layui-form" action="">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="card_name" value="{{$data['card_name']}}" required  lay-verify="required" placeholder="卡片名称" autocomplete="off" class="layui-input">
                    </div>
                </div>
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        ...
                        <div class="layui-upload-list">
                            <img id="cardimgs" style="width: 200px;" src="{{$data['card_img']}}" alt="">
                            <input type="hidden" name="card_img" value="{{$data['card_img']}}" lay-verify="required" id="card_img">
                        </div>
                    </div>
                </div>
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        ...
                        <div class="layui-upload-list">
                            <img id="cardwholeimgs" style="width: 200px;" src="{{$data['card_whole_img']}}" alt="">
                            <input type="hidden" name="card_whole_img" value="{{$data['card_whole_img']}}" lay-verify="required" id="card_whole_img">
                        </div>
                    </div>
                </div>
                <div class="layui-form-item">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="card_number" value="{{$data['card_number']}}" required  lay-verify="required" placeholder="库存" autocomplete="off" class="layui-input">
                    </div>
                </div>
                <div class="layui-form-item">
                    <label class="layui-form-label">特权说明：</label>
                    <div class="layui-input-block">
                        <input type="text" name="card_brief" value="{{$data['card_brief']}}" required  lay-verify="required" placeholder="特权说明" autocomplete="off" class="layui-input">
                    </div>
                </div>
                <div class="layui-form-item">
                    <label class="layui-form-label">有效天数：</label>
                    <div class="layui-input-block">
                        <input type="text" name="card_period" value="{{$data['card_period']}}" required  lay-verify="required" placeholder="有效天数" autocomplete="off" class="layui-input">
                    </div>
                </div>
                <div class="layui-form-item">
                    <label class="layui-form-label">联系电话：</label>
                    <div class="layui-input-block">
                        <input type="text" name="phone" value="{{$data['phone']}}" required  lay-verify="required" placeholder="联系电话" autocomplete="off" class="layui-input">
                    </div>
                </div>
                <div class="layui-form-item">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="shop_id" value="{{$data['shop_id']}}" required  lay-verify="required" placeholder="适用门店（门店 id 用,隔开）" autocomplete="off" class="layui-input">
                    </div>
                </div>
                <div class="layui-form-item">
                    <label class="layui-form-label">使用须知：</label>
                    <div class="layui-input-block">
                        <textarea name="card_notice" placeholder="使用须知" class="layui-textarea">{{$data['card_notice']}}</textarea>
                    </div>
                </div>
                <div class="layui-form-item">
                    <div class="layui-input-block">
