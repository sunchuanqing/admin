    ...
    <div class="admin-overall">
        ...
        <div class="admin-table">
            <div class="admin-search">
                <a href="/card/create" class="layui-btn add">
                    ...
                    <div class="layui-form-item">
                        <div class="layui-inline">
                            <div class="layui-input-inline" style="width: 200px;">
                                <input type="text" name="card_name" placeholder="卡片名称" autocomplete="off" class="layui-input">
                            </div>
                        </div>
        ...
        layui.use('table', function(){
            ...
            var tableIns = table.render({
                ...
                ,cols: [[
                    ...
                    ,{field: 'card_name', title: '卡片名称', width:150}
                    ,{field: 'shop_id', title: '适用门店', width: 100}
                    ,{field: 'price', title: '价格', width:100}
                    ,{field: 'vip_price', title: '会员价', width:100}
                    ,{field: 'card_number', title: '库存', width:100}
                    ,{field: 'card_period', title: '有效天数', width: 100}
                    ,{field: 'phone', title: '手机号', width: 120}
                    ,{field: 'status', title: '状态', width:100, templet: function(d){if(d.status === 1){return '在售';}else{return '下架';}}}
                    ,{field: 'card_brief', title: '特权说明', width:250}
            ...
            table.on('tool(list)', function(obj){
                ...
                if(layEvent === 'del'){
                    ...
                    window.location.href = "/card/"+data.id+'/edit';
                }
            });
        });
    </script>
