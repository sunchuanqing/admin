    ...
    <div class="admin-overall">
        <div class="admin-nav">
            <span class="layui-breadcrumb">
                <a href="/">主页</a>
                <a href="/shop">门店列表</a>
                <a href="/shop_photo/{{$data['shop_id']}}">门店相册列表</a>
                <a><cite>修改相册</cite></a>
            </span>
        </div>
        <div class="add">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        ...
                        <div class="layui-upload-list">
                            <img id="shopphotos" style="width: 300px; height: 160px;" src="{{$data['shop_thumb']}}" alt="">
                            <input type="hidden" name="shop_photo" lay-verify="required" value="{{$data['original_img']}}" id="shop_photo">
                        </div>
                    </div>
                </div>
                <div class="layui-form-item">
    ...
    <script>
        ...
        layui.use('form', function(){
            ...
            form.on('submit(formDemo)', function(data){
                ...
                $.ajax({
                    type: 'put',
                    url: '/shop_photo/'+data.field.id,
                    data: {'_token': '{{csrf_token()}}', 'shop_photo': data.field.shop_photo, 'sort': data.field.sort},
                    dataType: 'json',
